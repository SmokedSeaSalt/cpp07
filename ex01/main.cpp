...
int main(void)
{
    ...
    std::cout << "intArray: ";
	iter(intArray, 5, printWithSpace<int>);
	std::cout << "\n";
	...
	iter(constintArray, 5, &printWithSpace<const int>);
	std::cout << "\n";
    ...
    std::cout << "floatArray: ";
	iter(floatArray, 5, &printWithSpace<float>);
	std::cout << "\n";
	...
	std::cout << "const floatArray: ";
	iter(constfloatArray, 5, &printWithSpace<const int>);
	std::cout << "\n";
